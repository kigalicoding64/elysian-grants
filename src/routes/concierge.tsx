    ...
    <div className="w-full">
      <section className="bg-slate-900 text-white dark:bg-slate-950">
        <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6">
          <h1 className="max-w-2xl text-4xl font-extrabold tracking-tight">
          ...
          <Button asChild variant="default" className="mt-8 bg-emerald-600 text-white hover:bg-emerald-700">
      ...
      <section className="mx-auto grid w-full max-w-7xl gap-5 px-4 py-16 sm:px-6 md:grid-cols-3">
        {STEPS.map((step) => (
          <div key={step.title} className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <step.icon className="size-6 text-emerald-600 dark:text-emerald-400" />
            <h2 className="mt-4 text-lg font-bold text-slate-900 dark:text-slate-100">{step.title}</h2>
      ...
      <section className="mx-auto w-full max-w-3xl px-4 pb-20 sm:px-6">
        <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">What is included</h2>
